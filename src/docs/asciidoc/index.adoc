...
==== Sample Request
include::{snippets}/packages/httpie-request.adoc[]

==== Sample Response
include::{snippets}/packages/http-response.adoc[]

include::{snippets}/packages/response-fields.adoc[]

== V1 Endpoints
These endpoints are currently deprected and will be slowly removed in favor of the v2 versions.
