...
public class PackageController {
	...
	public @ResponseBody List<PackageView> getAllPackages(HttpServletRequest request)
		...
		logger.logInfoMessage(this.getClass(), null, null, request.getRequestURI(), "Request for all packages");
	...
	public @ResponseBody FileUploadResponse postFilesToPackage(@PathVariable("packageId") String packageId,
		...
		logger.logInfoMessage(this.getClass(), null, packageId, request.getRequestURI(), message);
	...
	public @ResponseBody ResponseEntity<Resource> downloadPackage(@PathVariable String packageId,
		...
		try {
			...
			logger.logErrorMessage(this.getClass(), null, packageId, requestURI,
		...
		logger.logInfoMessage(this.getClass(), null, packageId, requestURI, message);
